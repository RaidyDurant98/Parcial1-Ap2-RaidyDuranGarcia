<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoriasForm.aspx.cs" Inherits="Parcial1_Ap2_RaidyDuran.UI.Registros.CategoriasForm" %>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="PresupuestoForm.aspx">Presupuestos</a>
                <a class="nav-item nav-link active" href="CategoriasForm.aspx">Categorias</a>
            </div>
        </div>
    </nav>
    <br />
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../Consultas/CategoriasConsulta.aspx">Consulta</a>
            </li>
        </ul>
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-5">
            <form id="CategoriaForm" runat="server">
                ...
                <div class="form-group">
                    <asp:Label ID="CategoriaIdLabel" runat="server" Text="Presupuesto Id:"></asp:Label>
                    <asp:TextBox CssClass="form-control" ID="CategoriaIdTextBox" runat="server" AutoComplete="off"></asp:TextBox>
                </div>
                <!--Descripcion-->
                <div class="form-group">
